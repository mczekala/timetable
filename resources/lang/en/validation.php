...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'time' => [
            'required' => 'Godzina rozprawy jest wymagana',
        ],
        'room' => [
            'required' => 'Numer pokoju jest wymagany',
        ],
        'signature' => [
            'required' => 'Sygnatura jest wymagana',
        ],
        'link' => [
            'required' => 'Link jest wymagany',
        ],
        'trial_date' => [
            'required' => 'Data rozprawy jest wymagana',
        ],
        'location' => [
        ...
        'app' => [
            'required' => 'Aplikacja jest wymagana',
        ],
        'trial_date' => [
            'after_or_equal' =>'Podana data jest wcześniejsza od aktualnej'
        ]
    ],
